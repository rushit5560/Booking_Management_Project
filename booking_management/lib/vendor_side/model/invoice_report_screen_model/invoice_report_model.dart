...
InvoiceReportModel invoiceReportModelFromJson(String str) => InvoiceReportModel.fromJson(json.decode(str));

String invoiceReportModelToJson(InvoiceReportModel data) => json.encode(data.toJson());
...
class InvoiceReportModel {
  ...
  int statusCode;
  bool success;
  List<InvoiceReportData> workerList;

  factory InvoiceReportModel.fromJson(Map<String, dynamic> json) => InvoiceReportModel(
    statusCode: json["statusCode"] ?? 0,
    success: json["success"] ?? false,
    workerList: List<InvoiceReportData>.from(json["workerList"].map((x) => InvoiceReportData.fromJson(x ?? {})) ?? []),
  );
...
class InvoiceReportData {
  ...
  factory InvoiceReportData.fromJson(Map<String, dynamic> json) => InvoiceReportData(
    id: json["id"] ?? 0,
