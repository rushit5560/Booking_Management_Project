...
class DataVendor {
  ...
  String modifiedBy;
  String modifiedOn;
  ApplicationUserModifierClass applicationUserModifier;
  String passwordHash;
  String notes;
  String bookingId;
  ...
  factory DataVendor.fromJson(Map<String, dynamic> json) => DataVendor(
    ...
    applicationUserModifier: ApplicationUserModifierClass.fromJson(json["applicationUserModifier"] ?? {}),
...
class ApplicationUserModifierClass {
  ApplicationUserModifierClass({
  ...
  factory ApplicationUserModifierClass.fromJson(Map<String, dynamic> json) => ApplicationUserModifierClass(
