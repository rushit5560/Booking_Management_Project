...
class AppColors {
  static Color colorLightGrey = Color.fromARGB(255, 196, 196, 196);
  static Color colorLightGrey1 = const Color(0xFFefefef);
  static Color colorLightGrey2 = Color.fromARGB(255, 240, 240, 240);
