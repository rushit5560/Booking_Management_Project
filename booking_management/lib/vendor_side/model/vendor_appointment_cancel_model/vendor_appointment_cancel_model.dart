...
VendorAppointmentCancelModel vendorAppointmentCancelModelFromJson(String str) =>
    VendorAppointmentCancelModel.fromJson(json.decode(str));

String vendorAppointmentCancelModelToJson(VendorAppointmentCancelModel data) =>
...
class VendorAppointmentCancelModel {
  ...
  factory VendorAppointmentCancelModel.fromJson(Map<String, dynamic> json) =>
      VendorAppointmentCancelModel(
