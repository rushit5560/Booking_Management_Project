...
//
//     final doneAppointmentListModel = doneAppointmentListModelFromJson(jsonString);

import 'dart:convert';

DoneAppointmentListModel doneAppointmentListModelFromJson(String str) => DoneAppointmentListModel.fromJson(json.decode(str));

String doneAppointmentListModelToJson(DoneAppointmentListModel data) => json.encode(data.toJson());

class DoneAppointmentListModel {
  DoneAppointmentListModel({
  ...
  factory DoneAppointmentListModel.fromJson(Map<String, dynamic> json) => DoneAppointmentListModel(
    statusCode: json["statusCode"] ?? 0,
    success: json["success"] ?? false,
    data: List<Done>.from(json["data"].map((x) => Done.fromJson(x))),
  );
