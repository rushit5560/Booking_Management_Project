...
import '../../controllers/appointment_details_screen_controller/scan_appointment_details_screen_controller.dart';

class UserImageModule extends StatelessWidget {
  UserImageModule({Key? key}) : super(key: key);
  final screenController = Get.find<ScanAppointmentDetailsScreenController>();
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () async {
        ...
        await vendorAppointmentListScreenController
